 ...
 */
class ProfileStrings extends \curriculum\model\ProfileStrings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'profile', 'locale', 'name', 'document'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProfileStrings $proxy) {
