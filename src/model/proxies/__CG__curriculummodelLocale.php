 ...
 */
class Locale extends \curriculum\model\Locale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'locale', 'description', 'language', 'country'];
        }
    ...
    public function setId($locale)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', [$locale]);

        return parent::setId($locale);
    }
